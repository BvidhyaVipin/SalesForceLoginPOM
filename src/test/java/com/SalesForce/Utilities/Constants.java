...
public class Constants {
	...
	public static final String APPLICATION_PROPERTIES=CUR_DIR+"\\src\\test\\resources\\SalesforceLogin.properties";
	//public static final String STUDETN_REGI_DATA_XLSX=CUR_DIR+"/src/test/resources/tekarchData.xlsx";
